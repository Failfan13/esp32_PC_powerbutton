...
//   button.attachLongPressStop(HoldButtonClick); // 2 seconds
//   button.attachMultiClick(ResetNetworkDetails); // 3 clicks
// }
...
// // Reset current network details (needs WifiManager.h)
// void ResetNetworkDetails() {
//   wm.resetSettings();
// }
